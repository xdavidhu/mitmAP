...
if proxy_if == "y" or proxy_if == "":
    if wireshark_if == "y" or wireshark_if == "":
        print(
            "[I] Traffic have been saved to the file 'mitmap-proxy.mitmproxy' and to file 'mitmap-wireshark.pcap'. View the '.mitmap' file later by 'mitmproxy -r [file]'.")
    else:
        print(
            "[I] Traffic have been saved to the file 'mitmap-proxy.mitmproxy'. View it later by 'mitmproxy -r [file]'.")
if sslstrip_if == "y" or sslstrip_if == "":
    if wireshark_if == "y" or wireshark_if == "":
