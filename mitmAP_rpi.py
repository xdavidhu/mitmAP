...
if update == "y" or update == "":
    ...
    os.system("sudo apt-get install python-pcapy -y > /dev/null 2>&1")
...
#DRIFTNET QUESTION
driftnet_if = raw_input("[?] Capture unencrypted images with DRIFTNET? (ONLY WORKS WITH GUI) y/N: ")
...
wireshark_if = raw_input("[?] Start WIRESHARK on " + ap_iface + "? (ONLY WORKS WITH GUI) y/N: ")
...
#SSLSTRIP MODE
    ...
    if proxy_if == "y" or proxy_if == "":
        ...
        try:
            ...
            print("")
        os.system("sudo mitmproxy -T --follow -w " + script_path + "logs/mitmap-proxy.mitmproxy")
        #STARTING POINT
    else:
        print("[I] Skipping...")
    #/MITMAP MODE
