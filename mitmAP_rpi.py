...
#DRIFTNET QUESTION
driftnet_if = input("[?] Capture unencrypted images with DRIFTNET? (ONLY WORKS WITH GUI) y/N: ")
...
wireshark_if = input("[?] Start WIRESHARK on " + ap_iface + "? (ONLY WORKS WITH GUI) y/N: ")
